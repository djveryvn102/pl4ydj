...
$.fn.ayoshare = function (h, j, k, l, m, n, o, p, q, r) {
    ...
    function ayo_facebook(c, d) {
        $.ajax({
            url: 'https://graph.facebook.com/?id=' + c,
            crossDomain: true,
            dataType: 'jsonp',
            success: function (a) {
